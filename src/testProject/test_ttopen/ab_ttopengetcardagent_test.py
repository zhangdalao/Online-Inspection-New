...
'''
@author: fanpl
@file: a_ttopengetcardagent_test.py
...
@ddt.ddt
class TtopengetcardagentTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Getcardagent"))
    def test_Getcardagent(self, value):
        # 通过函数名获取apiName参数的值
