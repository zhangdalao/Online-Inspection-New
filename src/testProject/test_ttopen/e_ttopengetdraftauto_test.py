...
'''
@author: fanpl
@file: e_ttopengetdraftauto_test.py
...
@ddt.ddt
class TtopengetdraftautoTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Getdraftauto"))
    def test_Getdraftauto(self, value):
        # 通过函数名获取apiName参数的值
