...
'''
@author: fanpl
@file: ttopenfetchuseralloriginlist_test.py
@time: 2019/10/23 15:54
@desc: 编辑页面-获取当前用户的所有来源列表
'''
...
@ddt.ddt
class TtopenfetchuseralloriginlistTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Fetchstatis"))
    def test_Fetchstatis(self, value):
        # 通过函数名获取apiName参数的值
