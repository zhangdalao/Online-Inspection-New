...
'''
@author: fanpl
@file: ttopenallpublishlist_test.py
@time: 2019/9/20 15:54
@desc: 开放平台-运营管理-全部文章列表
'''
...
@ddt.ddt
class TtopenallpublishlistTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Allpublishlist"))
    def test_Allpublishlist(self, value):
        # 通过函数名获取apiName参数的值
