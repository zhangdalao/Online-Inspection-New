...
'''
@author: fanpl
@file: a_ttopenreleasearticledraft_test.py
@time: 2019/10/22 15:54
@desc: 开放平台-创作-发布文章-保存草稿测试
'''
...
@ddt.ddt
class TtopenreleasearticledraftTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Releasearticledraft"))
    def test_Releasearticledraft(self, value):
        # 通过函数名获取apiName参数的值
