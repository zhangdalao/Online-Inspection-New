...
'''
@author: fanpl
@file: e_ttopenadddraftauto_test.py
@time: 2019/10/22 15:54
@desc: 开放平台-创作-发布文章-自动保存草稿
'''
...
@ddt.ddt
class TtopenadddraftautoTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Adddraftauto"))
    def test_Adddraftauto(self, value):
        # 通过函数名获取apiName参数的值
