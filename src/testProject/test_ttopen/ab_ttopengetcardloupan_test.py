...
'''
@author: fanpl
@file: a_ttopengetcardloupan_test.py
...
@ddt.ddt
class TtopengetcardloupanTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Getcardloupan"))
    def test_Getcardloupan(self, value):
        # 通过函数名获取apiName参数的值
