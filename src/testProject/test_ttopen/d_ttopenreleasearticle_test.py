...
'''
@author: fanpl
@file: a_ttopenreleasearticle_test.py
@time: 2019/10/22 15:54
@desc: 开放平台-创作-发布文章-发布文章测试
'''
...
@ddt.ddt
class TtopenreleasearticleTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Releasearticle"))
    def test_Releasearticle(self, value):
        # 通过函数名获取apiName参数的值
