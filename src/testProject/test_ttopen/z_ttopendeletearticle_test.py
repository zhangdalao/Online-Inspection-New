...
'''
@author: fanpl
@file: a_ttopendeletearticle_test.py
@time: 2019/10/22 15:54
@desc: 开放平台-我的文章-已发布-删除按钮  或者 运营管理-全部文章-删除按钮
'''
...
@ddt.ddt
class TtopendeletearticleTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Deletearticle"))
    def test_Deletearticle(self, value):
        # 通过函数名获取apiName参数的值
