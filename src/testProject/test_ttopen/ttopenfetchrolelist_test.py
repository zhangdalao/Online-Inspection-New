...
'''
@author: fanpl
@file: ttopenfetchrolelist_test.py
@time: 2019/10/23 15:54
@desc: 权限管理-角色管理-系统权限角色列表获取
'''
...
@ddt.ddt
class TtopenfetchrolelistTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Fetchrolelist"))
    def test_Fetchrolelist(self, value):
        # 通过函数名获取apiName参数的值
