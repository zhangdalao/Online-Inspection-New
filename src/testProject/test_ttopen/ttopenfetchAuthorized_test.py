...
'''
@author: fanpl
@file: ttopenfetchAuthorized_test.py
...
@ddt.ddt
class TtopenfetchAuthorizedTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "FetchAuthorized"))
    def test_FetchAuthorized(self, value):
        # 通过函数名获取apiName参数的值
