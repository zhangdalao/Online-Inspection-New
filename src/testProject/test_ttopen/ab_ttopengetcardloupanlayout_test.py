...
'''
@author: fanpl
@file: a_ttopengetcardloupanlayout_test.py
...
@ddt.ddt
class TtopengetcardloupanlayoutTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Getcardloupanlayout"))
    def test_Getcardloupanlayout(self, value):
        # 通过函数名获取apiName参数的值
