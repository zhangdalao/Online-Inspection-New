...
'''
@author: fanpl
@file: ttopenfetchalloriginlist_test.py
@time: 2019/10/23 15:54
@desc: 权限管理-用户新增-所有的来源列表
'''
...
@ddt.ddt
class TtopenfetchalloriginlistTest(RunTest):
    """列表模块"""

    # 通过文件名夹获取project参数的值
    project = os.path.dirname(__file__)[-6:]
    # 读取文件实例化
    a = ReadData(project,jsonName="ttopen")
    # 通过类名获取fieldname的值
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Fetchalloriginlist"))
    def test_Fetchalloriginlist(self, value):
        # 通过函数名获取apiName参数的值
