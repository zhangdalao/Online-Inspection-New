...
'''
@author: fanpl
@file: ttopencheckarticlelist_test.py
@time: 2019/9/20 15:54
@desc: 开放平台-运营管理-先审后发列表
'''
...
@ddt.ddt
class TtopencheckarticlelistTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Checkarticlelist"))
    def test_Checkarticlelist(self, value):
        # 通过函数名获取apiName参数的值
