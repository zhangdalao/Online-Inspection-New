...
'''
@author: fanpl
@file: a_ttopencheckarticle_test.py
@time: 2019/10/22 15:54
@desc: 开放平台-运营管理-先审后发-审核文章
'''
...
@ddt.ddt
class TtopencheckarticleTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Checkarticle"))
    def test_Checkarticle(self, value):
        # 通过函数名获取apiName参数的值
