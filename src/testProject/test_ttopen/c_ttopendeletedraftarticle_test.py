...
'''
@author: fanpl
@file: a_ttopendeletedraftarticle_test.py
@time: 2019/10/22 15:54
@desc: 开放平台-我的文章-草稿列表页-删除草稿
'''
...
@ddt.ddt
class TtopendeletedraftarticleTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Deletedraftarticle"))
    def test_Deletedraftarticle(self, value):
        # 通过函数名获取apiName参数的值
