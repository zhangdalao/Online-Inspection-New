...
'''
@author: fanpl
@file: a_ttopengetcardmlsestate_test.py
@time: 2019/10/25 19:54
@desc: 联卖房源数据获取
'''
...
@ddt.ddt
class TtopengetcardmlsestateTest(RunTest):
    """列表模块"""
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "Getcardmlsestate"))
    def test_Getcardmlsestate(self, value):
        # 通过函数名获取apiName参数的值
