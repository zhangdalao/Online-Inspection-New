...
class TtopenloginTest(RunTest):
    ...
    def tearDown(self):
        if self.result:
            try:
                ...
                sss["cookie_value"] = "CMSTOKEN=" + json.loads(str(self.result.content, 'utf-8'))['data']['token']
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "ByCaptcha"))
    def test_ByCaptcha(self, value):
        # 通过函数名获取apiName参数的值
