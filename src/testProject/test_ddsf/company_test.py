...
class CompanyTest(RunTest):
	...
	@ddt.data(*a.get_data_by_api(fieldname, "CompanyList"))
	def test_CompanyList(self, value):
		"""城市区域列表"""
		# 通过函数名获取apiName参数的值
		...
		# 调用接口发起请求
		sss["cityIdList"] = ["3", "450", "619", "852", "1406", "2179", "9393", "10204"]
