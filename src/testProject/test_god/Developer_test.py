...
class DeveloperTest(RunTest):
    ...
    def test_DeveloperList(self, value):
        ...
        try:
            ...
            send_ding(robot_url, mobile, content=f"开发商列表异常，接口返回为：{self.res}, 接口预期结果为：{self.expect}")
            raise err
    ...
    def test_DeveloperSearch(self, value):
        ...
        try:
            ...
            robot_url = json_dict["robot_url"]
            mobile = json_dict["mobile"]
            send_ding(robot_url, mobile, content=f"开发商搜索异常，接口返回为：{self.res}, 接口预期结果为：{self.expect}")
            raise err
    ...
    def test_DeveloperEidt(self, value):
        ...
        try:
            ...
            robot_url = json_dict["robot_url"]
            mobile = json_dict["mobile"]
            send_ding(robot_url, mobile, content=f"开发商编辑异常，接口返回为：{self.res}, 接口预期结果为：{self.expect}")
            raise err
