...
class FactoringTest(RunTest):
	...
	@ddt.data(*a.get_data_by_api(fieldname, "AuditedSummary"))
	def test_AuditedSummary(self, value):
		# 通过函数名获取apiName参数的值
		self.apiName = (inspect.stack()[0][3])[5:]
		# 获取测试环境参数
		env = value[self.env_num]
	...
	@ddt.data(*a.get_data_by_api(fieldname, "ProfitRate"))
	def test_ProfitRate(self, value):
		# 通过函数名获取apiName参数的值
		self.apiName = (inspect.stack()[0][3])[5:]
		# 获取测试环境参数
		env = value[self.env_num]
	...
	@ddt.data(*a.get_data_by_api(fieldname, "4_RuleDetail"))
	def test_4_RuleDetail(self, value):
		# 通过函数名获取apiName参数的值
		self.apiName = (inspect.stack()[0][3])[5:]
		# 获取测试环境参数
		env = value[self.env_num]
	...
	@ddt.data(*a.get_data_by_api(fieldname, "RuleProfit"))
	def test_RuleProfit(self, value):
		# 通过函数名获取apiName参数的值
		self.apiName = (inspect.stack()[0][3])[5:]
		# 获取测试环境参数
		env = value[self.env_num]
	...
	@ddt.data(*a.get_data_by_api(fieldname, "ProjectCooperation"))
	def test_ProjectCooperation(self, value):
		# 通过函数名获取apiName参数的值
		self.apiName = (inspect.stack()[0][3])[5:]
		# 获取测试环境参数
		env = value[self.env_num]
