...
class LoanTest(RunTest):
	...
	@ddt.data(*a.get_data_by_api(fieldname, "LoanOrderList"))
	def test_LoanOrderList(self, value):
		# 通过函数名获取apiName参数的值
	...
	# @ddt.data(*a.get_data_by_api(fieldname, "exportOrdersExcel"))
	# def test_exportOrdersExcel(self, value):
	# 	# 通过函数名获取apiName参数的值
	# 	self.apiName = (inspect.stack()[0][3])[5:]
	# 	# 获取测试环境参数
	# 	env = value[self.env_num]
	...
	@ddt.data(*a.get_data_by_api(fieldname, "merchantIdList"))
	def test_merchantIdList(self, value):
		# 通过函数名获取apiName参数的值
		self.apiName = (inspect.stack()[0][3])[5:]
		# 获取测试环境参数
		env = value[self.env_num]
