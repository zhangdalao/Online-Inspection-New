...
class IMTest(RunTest):
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "ImAutoList"))
    def test_ImAutoList(self, value):
        # 通过函数名获取apiName参数的值
        self.apiName = (inspect.stack()[0][3])[5:]
        # 获取测试环境参数
        env = value[self.env_num]
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "ImAutoEdit"))
    def test_ImAutoEdit(self, value):
        # 通过函数名获取apiName参数的值
        self.apiName = (inspect.stack()[0][3])[5:]
        # 获取测试环境参数
        env = value[self.env_num]
