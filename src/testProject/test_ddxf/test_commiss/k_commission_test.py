...
class commissionTest(RunTest):
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "amountnormal"))
    def test_amountnormal(self, value):
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "bamoumtfactor"))
    def test_bamoumtfactor(self, value):
        self.desc = value[self.desc_num]
        # 通过函数名获取apiName参数的值
        self.apiName = (inspect.stack()[0][3])[5:]
        # 获取测试环境参数
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "crepaydetail"))
    def test_crepaydetail(self, value):
        self.desc = value[self.desc_num]
        # 通过函数名获取apiName参数的值
        self.apiName = (inspect.stack()[0][3])[5:]
        # 获取测试环境参数
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "drecoverabledetail"))
    def test_drecoverabledetail(self, value):
        self.desc = value[self.desc_num]
        # 通过函数名获取apiName参数的值
        self.apiName = (inspect.stack()[0][3])[5:]
        # 获取测试环境参数
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "ededucedetail"))
    def test_ededucedetail(self, value):
        self.desc = value[self.desc_num]
        # 通过函数名获取apiName参数的值
        self.apiName = (inspect.stack()[0][3])[5:]
        # 获取测试环境参数
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "fOrder"))
    def test_fOrder(self, value):
        self.desc = value[self.desc_num]
        # 通过函数名获取apiName参数的值
        self.apiName = (inspect.stack()[0][3])[5:]
        # 获取测试环境参数
