...
class WorkbaseTest(RunTest):
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "brief_report"))
    def test_brief_report(self, value):
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "funnel_data"))
    def test_funnel_data(self, value):
        self.apiName = (inspect.stack()[0][3])[5:]
        #  获取测试环境参数
        env = value[self.env_num]
        # 通过环境参数获得接口url
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "operation_data"))
    def test_operation_data(self, value):
        self.apiName = (inspect.stack()[0][3])[5:]
        #  获取测试环境参数
        env = value[self.env_num]
        # 通过环境参数获得接口url
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "member_achievement"))
    def test_member_achievement(self, value):
        self.apiName = (inspect.stack()[0][3])[5:]
        #  获取测试环境参数
        env = value[self.env_num]
        # 通过环境参数获得接口url
