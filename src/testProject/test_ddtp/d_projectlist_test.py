...
class ProjectlistTest(RunTest):
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "projectlist_filter"))
    def test_projectlist_filter(self, value):
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "get_district"))
    def test_get_district(self, value):
        self.apiName = (inspect.stack()[0][3])[5:]
        #  获取测试环境参数
        env = value[self.env_num]
        # 通过环境参数获得接口url
