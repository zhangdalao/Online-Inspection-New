...
class MapsTest(RunTest):
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "map_default"))
    def test_map_default(self, value):
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "point_store"))
    def test_point_store(self, value):
        self.apiName = (inspect.stack()[0][3])[5:]
        #  获取测试环境参数
        env = value[self.env_num]
        # 通过环境参数获得接口url
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "map_estate_data"))
    def test_map_estate_data(self, value):
        self.apiName = (inspect.stack()[0][3])[5:]
        #  获取测试环境参数
        env = value[self.env_num]
        # 通过环境参数获得接口url
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "map_store_data"))
    def test_map_store_data(self, value):
        self.apiName = (inspect.stack()[0][3])[5:]
        #  获取测试环境参数
        env = value[self.env_num]
        # 通过环境参数获得接口url
