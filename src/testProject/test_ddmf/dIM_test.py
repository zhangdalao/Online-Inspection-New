...
class IMTest(RunTest):
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "IM_config"))
    def test_IM_config(self, value):
        # 通过函数名获取apiName参数的值
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "IM_contacter"))
    def test_IM_contacter(self, value):
        # 通过函数名获取apiName参数的值
        self.apiName = (inspect.stack()[0][3])[5:]
        # 获取测试环境参数
        env = value[self.env_num]
    ...
    @ddt.data(*a.get_data_by_api(fieldname, "IM_msgList"))
    def test_IM_msgList(self, value):
        # 通过函数名获取apiName参数的值
        self.apiName = (inspect.stack()[0][3])[5:]
        # 获取测试环境参数
        env = value[self.env_num]
